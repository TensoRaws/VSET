<template>
 ...
 -->
      ...
      <div class="flex-container" v-if="SRMethodValue === 'Waifu2x'">
        ...
        <div class="flex-container" v-if="SRMethodValue === 'SR_ExtraModel'">
          <div class="slider-demo-block">
      ...
      <n-button @click="ShowSrExtra" type="primary" size="small"
      style="height: 30px; width: 130px; background-color: #409eff; border-color: #ff6600; font-size: 18px; padding: 10px 24px; border-radius: 9px;">
      Extra
    </n-button>
 ...
 <!-- 分页 2：补帧配置 -->
    ...
    <div class="flex-container-extra">
      <n-button @click="ShowVfiExtra" type="primary" size="small"
      style="height: 30px; width: 130px; background-color: #409eff; border-color: #ff6600; font-size: 18px; padding: 10px 24px; border-radius: 9px;">
      Extra
    </n-button>
